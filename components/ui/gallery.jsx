...
import { LayoutGrid } from "./LayoutGrid";  // Import LayoutGrid

// Skeleton Components for each card
const SkeletonOne = () => (
  <div>
...
const cards = [
  {
    id: 1,
    content: <SkeletonOne />,  // JSX content for card
...
const Gallery = () => {  // Use PascalCase for component name
  return (
    <div className="h-screen py-20 w-full">
      <LayoutGrid cards={cards} />  {/* Pass cards data to LayoutGrid */}
    </div>
  );
};
